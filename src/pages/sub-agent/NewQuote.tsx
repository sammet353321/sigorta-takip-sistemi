...
export default function NewQuote() {
  ...
  const handlePaste = async () => {
    try {
      ...
      if (!imageFound) {
        alert('Panoda uygun resim bulunamadı. Lütfen bir resim dosyasını değil, resmin kendisini kopyaladığınızdan emin olun.');
      }
    } catch (err) {
      console.error('Paste failed:', err);
      alert('Pano erişimi başarısız veya görsel bulunamadı. "Ctrl+V" deneyin.');
    }
  };
