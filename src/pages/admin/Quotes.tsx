...
export default function AdminQuotesPage() {
    ...
    const filteredQuotes = quotes.filter(q => 
        ...
        (q.ad_soyad && q.ad_soyad.toLowerCase().includes(searchTerm.toLowerCase()))
    );
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            type="text" 
                            placeholder="Plaka veya İsim Ara..." 
                            value={searchTerm}
                ...
                <table className="w-full text-sm text-left">
                    <thead className="bg-gray-50 text-gray-600 font-medium">
                        <tr>
                            ...
                            <th className="px-6 py-3">İlgilenen</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {filteredQuotes.map((quote) => (
                            <tr key={quote.id} className="hover:bg-gray-50 transition-colors">
                                <td className="px-6 py-4 font-medium">{quote.plaka}</td>
                                ...
                                <td className="px-6 py-4 text-gray-500">
                                    {format(new Date(quote.tarih), 'd MMM HH:mm', { locale: tr })}
                                </td>
