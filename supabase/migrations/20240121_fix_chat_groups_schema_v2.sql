...
ALTER TABLE chat_group_permissions DROP CONSTRAINT IF EXISTS chat_group_permissions_group_id_fkey; -- Added this
...
ALTER TABLE chat_group_permissions ALTER COLUMN group_id TYPE text; -- Added this
